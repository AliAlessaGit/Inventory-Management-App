    ...
    public TilePanel(
        ...
        deleteBtn.addActionListener(
                e -> {
                    ...
                    /*
                     * مهم:
                     * selectedRow هو رقم الصف الظاهر في الجدول،
                     * لذلك نأخذ العنصر من displayedItems وليس
                     * مباشرة من tileService.getAll().
                     */
                    ...
                    try {
                        ...
                        /*
                         * إعادة تطبيق البحث والفلترة الحالية
                         * حتى يختفي العنصر من الجدول مباشرة.
                         */
                        applyCurrentFilterAndSearch();
