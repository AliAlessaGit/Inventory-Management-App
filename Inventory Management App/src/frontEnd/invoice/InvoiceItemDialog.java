...
public class InvoiceItemDialog {
    ...
    public void show() {
        ...
        // =========================================================
// التنقل بين اختيار البلاط والأدوات الصحية
// =========================================================

        tileRadio.getInputMap(
        ...
        tileRadio.getActionMap().put(
                ...
                new AbstractAction() {
                    ...
                    public void actionPerformed(
                        ...
                        sanitaryRadio.requestFocusInWindow();
                    }
                }
        );

        sanitaryRadio.getInputMap(
                JComponent.WHEN_FOCUSED
        ).put(
                KeyStroke.getKeyStroke(
                        KeyEvent.VK_LEFT,
        ...
        sanitaryRadio.getActionMap().put(
                "moveToTile",
                new AbstractAction() {
                    @Override
                    public void actionPerformed(
                        ...
                        tileRadio.requestFocusInWindow();
                    }
                }
        );
...
// =========================================================
        ...
        // =========================================================
// السهم للأعلى من البحث إلى اختيار النوع
// =========================================================

        searchField.getInputMap(
                JComponent.WHEN_FOCUSED
        ).put(
                KeyStroke.getKeyStroke(
                        KeyEvent.VK_UP,
        ...
        // =========================================================
// السهم للأسفل من البحث = تطبيق البحث + أول عنصر
// =========================================================
        ...
        // =========================================================
// Enter داخل الجدول = الانتقال إلى زر الإضافة
// =========================================================

        invTable.getInputMap(
                JComponent.WHEN_FOCUSED
        ).put(
                KeyStroke.getKeyStroke(
                        KeyEvent.VK_ENTER,
                ...
                new AbstractAction() {
                    ...
                    public void actionPerformed(
                        ...
                        if (invTable.getSelectedRow() >= 0) {
                            ...
                            confirmAddBtn.requestFocusInWindow();
                        }
                    }
                }
        );
