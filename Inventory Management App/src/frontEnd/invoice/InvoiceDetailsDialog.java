...
public class InvoiceDetailsDialog {
    ...
    private static final int CUSTOMER_PANEL_HEIGHT = 105;
...
// =====================================================
        ...
        notePanel.setComponentOrientation(
                ComponentOrientation.RIGHT_TO_LEFT
        );
        ...
        editCustomerBtn.addActionListener(
                e -> {
                    ...
                    JTextArea noteEditArea =
                            new JTextArea();

                    noteEditArea.setText(
                            invoice.getNote() == null
                                    ? ""
                                    : invoice.getNote()
                    );
                    ...
                    noteEditArea.setFont(
                            noteEditArea.getFont()
                                    .deriveFont(
                                            (float) LABEL_FONT_SIZE
                                    )
                    );

                    JScrollPane noteEditScrollPane =
                            new JScrollPane(
                                    noteEditArea
                            );

                    noteEditScrollPane.setPreferredSize(
                            new Dimension(
                                    CUSTOMER_PANEL_WIDTH,
                                    CUSTOMER_PANEL_HEIGHT
                            )
                    ...
                    customerFieldsPanel.setComponentOrientation(
                            ComponentOrientation.RIGHT_TO_LEFT
                    );

                    customerFieldsPanel.add(
                            nameField
                    );
...
// =================================================
                    ...
                    JPanel noteEditPanel =
                            new JPanel(
                                    new BorderLayout()
                            );

                    noteEditPanel.setComponentOrientation(
                            ComponentOrientation.RIGHT_TO_LEFT
                    );
...
// =================================================
                    ...
                    if (
                        ...
                        // =================================================
                        // تحديث بيانات العميل في الواجهة
                        // =================================================
                        ...
                        // =================================================
                        // تحديث صندوق الملاحظة في واجهة الفاتورة
                        // =================================================
